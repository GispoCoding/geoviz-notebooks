...
class CitySelectionForm(FlaskForm):
    map = LeafletField()
    city = StringField('Type the name of the city, or click on the map to select a specific neighborhood')
    bbox = StringField('Adjust the bounding box on the map, if needed')
